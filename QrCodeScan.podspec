...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                           It is a QrCodeScan util used on iOS, which implement by Objective-C.  
                   DESC

  s.homepage     = "https://github.com/caobo56/QrCodeScan"
  ...
  s.source       = { :git => "https://github.com/caobo56/QrCodeScan.git", :tag => "1.0.7" }
